...
(def inputdata
    (vec (map #(num (BigInteger. %))
        (str/split
            (str/trim (slurp (clojure.java.io/file (clojure.java.io/resource  "2019/day25/input.txt"))))
            #","))))
                ...
                (let [opc (get data index)
                    ...
                    (case opcode
                        ...
                        3   (recur
                                ...
                                relative-base)
                        4   (do
                                (print (str (char (get-value data p1 (+ index 1) relative-base))))
                                ;(flush)
...
; Use to supply instructions
(defn read-input [channel]
    (let [ascii (concat (string-to-ascii (read-line)) [10])]
        (if (> (count ascii) 1)
            (for [a ascii]
                (async/put! channel a)))))
...
(defn part1 []
    (run-computer inputdata (concat
        (string-to-ascii "south") [10]
        (string-to-ascii "take boulder") [10]
        (string-to-ascii "east") [10]
        (string-to-ascii "take food ration") [10]
        (string-to-ascii "west") [10]
        (string-to-ascii "west") [10]
        (string-to-ascii "take asterisk") [10]
        (string-to-ascii "east") [10]
        (string-to-ascii "north") [10]
        (string-to-ascii "east") [10]
        (string-to-ascii "take candy cane") [10]
        (string-to-ascii "north") [10]
        (string-to-ascii "east") [10]
        (string-to-ascii "north") [10]
        (string-to-ascii "take mug") [10]
        (string-to-ascii "south") [10]
        (string-to-ascii "west") [10]
        (string-to-ascii "north") [10]
        (string-to-ascii "take mutex") [10]
        (string-to-ascii "north") [10]
        (string-to-ascii "take prime number") [10]
        (string-to-ascii "south") [10]
        (string-to-ascii "south") [10]
        (string-to-ascii "south") [10]
        (string-to-ascii "east") [10]
        (string-to-ascii "north") [10]
        (string-to-ascii "take loom") [10]
        (string-to-ascii "south") [10]
        (string-to-ascii "east") [10]
        (string-to-ascii "south") [10]
        (string-to-ascii "east") [10]
        (string-to-ascii "east") [10]
        (string-to-ascii "drop boulder") [10]
        (string-to-ascii "drop food ration") [10]
        (string-to-ascii "drop candy cane") [10]
        (string-to-ascii "drop loom") [10]
        (string-to-ascii "north") [10]
        )))
